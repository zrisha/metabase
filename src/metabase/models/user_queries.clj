(ns metabase.models.user-queries
...
(models/defmodel UserQueries :user_queries)

(defn- pre-insert [user_queries]
  (let [defaults {:timestamp :%now}]
    (merge defaults user_queries)))

(u/strict-extend (class UserQueries)
  models/IModel
  (merge models/IModelDefaults
         {:types      (constantly {:query :keyword
                                   :json_query :json})
